export const RouterABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        components: [
          { name: "stopLossSet", type: "bool", internalType: "bool" },
          { name: "takeProfitSet", type: "bool", internalType: "bool" },
          {
  ...
  },
  {
    ...
    inputs: [
      { name: "_id", type: "bytes32", internalType: "MarketId" },
      { name: "_key", type: "bytes32", internalType: "bytes32" },
      { name: "_isPositionKey", type: "bool", internalType: "bool" },
    ],
    outputs: [
      {
  ...
  { type: "error", name: "Router_CantWrapUSDC", inputs: [] },
  { type: "error", name: "Router_InvalidAmountIn", inputs: [] },
  { type: "error", name: "Router_InvalidAmountInForWrap", inputs: [] },
  { type: "error", name: "Router_InvalidAsset", inputs: [] },
  { type: "error", name: "Router_InvalidAssetId", inputs: [] },
  { type: "error", name: "Router_InvalidCollateralToken", inputs: [] },
  { type: "error", name: "Router_InvalidConditional", inputs: [] },
  { type: "error", name: "Router_InvalidLimitPrice", inputs: [] },
  { type: "error", name: "Router_InvalidOwner", inputs: [] },
  { type: "error", name: "Router_InvalidRequest", inputs: [] },
  {
    type: "error",
  ...
  { type: "error", name: "Router_InvalidTokenIn", inputs: [] },
  { type: "error", name: "Router_InvalidTokenOut", inputs: [] },
  { type: "error", name: "Router_InvalidUpdateFee", inputs: [] },
  { type: "error", name: "Router_MarketDoesNotExist", inputs: [] },
  { type: "error", name: "Router_SizeExceedsPosition", inputs: [] },
