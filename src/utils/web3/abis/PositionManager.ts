export const PositionManagerABI = [
  ...
  {
    type: "function",
    name: "executionAttempted",
    inputs: [{ name: "orderKey", type: "bytes32", internalType: "bytes32" }],
  ...
  },
  {
    ...
    inputs: [
      { name: "_base", type: "uint256", internalType: "uint256" },
      { name: "_transfer", type: "uint256", internalType: "uint256" },
      { name: "_deposit", type: "uint256", internalType: "uint256" },
      { name: "_withdrawal", type: "uint256", internalType: "uint256" },
      { name: "_position", type: "uint256", internalType: "uint256" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  {
    type: "event",
    name: "PositionManager_HoldingTokens",
    inputs: [
      {
        name: "user",
        type: "address",
  ...
  { type: "error", name: "PositionManager_InvalidKey", inputs: [] },
  { type: "error", name: "PositionManager_InvalidMarket", inputs: [] },
  {
    type: "error",
